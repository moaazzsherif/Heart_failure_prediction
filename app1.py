...
<div class="navbar">
  ...
  <div style="display:flex;align-items:center;gap:16px">
    <span class="nav-acc">Gradient Boosting · 918 patients · 96.2% Accuracy</span>
...
if "Dashboard" in page:
    ...
    <div class="hero">
      ...
      <div class="hero-sub">Predictive analytics across 918 patients. Gradient Boosting tuned to 96.2% accuracy with threshold optimization for clinical safety.</div>
      <div class="stats-row">
    ...
    st.markdown("""
    <div class="kpi-row">
      <div class="kpi" style="--c:#dc2626;animation-delay:.0s"><div class="kpi-ico">🎯</div><div class="kpi-v">96.2%</div><div class="kpi-l">Accuracy</div></div>
      <div class="kpi" style="--c:#f97316;animation-delay:.1s"><div class="kpi-ico">⚡</div><div class="kpi-v">96.6%</div><div class="kpi-l">F1 Score</div></div>
      <div class="kpi" style="--c:#8b5cf6;animation-delay:.2s"><div class="kpi-ico">🔬</div><div class="kpi-v">96.1%</div><div class="kpi-l">Precision</div></div>
      <div class="kpi" style="--c:#10b981;animation-delay:.3s"><div class="kpi-ico">🩺</div><div class="kpi-v">97.1%</div><div class="kpi-l">Recall</div></div>
      <div class="kpi" style="--c:#3b82f6;animation-delay:.4s"><div class="kpi-ico">📈</div><div class="kpi-v">0.970</div><div class="kpi-l">ROC-AUC</div></div>
    </div>
    """, unsafe_allow_html=True)
